...
namespace YNDotNetCore.RestApiWithNLayer.Features.LatHtaukBayDin
{
    ...
    public class LatHtaukBayDinController : ControllerBase
    {
        ...
        private async Task<LatHtaukBayDin> GetDataAsync()
        {
            ...
            var model = JsonConvert.DeserializeObject<LatHtaukBayDin>(jsonStr);//Json to C# ??? package (newtonSoft)
            return model;
        }
